  ...
  return (
    <header className="grain-overlay sticky top-0 z-50 border-b border-[rgba(221,215,203,0.82)] bg-[rgba(250,248,244,0.84)] shadow-[0_10px_28px_rgba(42,38,56,0.06)] backdrop-blur-2xl">
      <div className="section-shell flex h-18 items-center justify-between gap-6 py-3">
        ...
        <div className="site-header-signal hidden xl:flex">
          <div className="site-header-signal-copy">
            <div className="site-header-signal-label">Marketplace mode</div>
            <div className="site-header-signal-title">Events, groups, venues, and revenue in one loop</div>
          </div>
        </div>
