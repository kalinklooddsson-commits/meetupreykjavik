...
export const categories = [
  { name: "Nightlife & Social", count: 3, letter: "N", tone: "coral" },
  { name: "Outdoors & Hiking", count: 2, letter: "O", tone: "sage" },
  { name: "Tech & Startups", count: 5, letter: "T", tone: "indigo" },
  { name: "Music & Arts", count: 3, letter: "M", tone: "sand" },
  { name: "Food & Drink", count: 3, letter: "F", tone: "coral" },
  { name: "Sports & Fitness", count: 2, letter: "S", tone: "sage" },
  { name: "Language Exchange", count: 1, letter: "L", tone: "indigo" },
  { name: "Expat Community", count: 3, letter: "E", tone: "coral" },
  { name: "Books & Culture", count: 1, letter: "B", tone: "sand" },
  { name: "Professional", count: 2, letter: "P", tone: "indigo" },
] as const;
